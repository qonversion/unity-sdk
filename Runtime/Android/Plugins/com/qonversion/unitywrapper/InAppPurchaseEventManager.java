...
class InAppPurchaseEventManager {
    ...
    private static final String PACKAGE_NAME = QonversionWrapper.getApplicationContext().getPackageName();

    private static final String SKU_DETAILS_STORE = "com.qonversion.internal.SKU_DETAILS";
    private static final String PURCHASE_INAPP_STORE = "com.qonversion.internal.PURCHASE";
    private static final SharedPreferences skuDetailSharedPrefs =
            QonversionWrapper.getApplicationContext()
